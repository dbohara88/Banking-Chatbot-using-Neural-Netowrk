...
#connecting sql 
#json will connect with xammp
with open('config.json', 'r') as c:
    params = json.load(c)["params"]

#running on local server
#will take templates using template_folder function
local_server = True
...
#decorator / calls home function and home function is returning index.html
@app.route("/")
def home():
    return render_template('index.html',params=params)
    
#all this table will be in ear.sql
...
#here it will pop the session and return to home page
